      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Numero de Confirmados (Total) <br><?php echo $confirmados ?></h2>
              <p>Dados referentes a data: <?php echo date("d/m/Y", strtotime($data_casos)) ?></p>
              </br>
              <p>Esse é o total de todas as pessoas que já tiveram a doença, neste total entram os casos já recuperados e casos de mortes ** </p>
              <p>No menu 'Casos Ativos' temos a quantidade real de casos contaminados</p>
            </div>
          </div>
